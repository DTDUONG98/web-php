        ...
        $(document).ready(function(){
            ...
            $('.delete').click(function(){
                ...
                $.ajax({
                    ...
                    success : function(data){
                        console.log(data);
                        document.location.href = 'http://localhost/shophuyka/Manage/admin.php';
                    }
                });
            });
        });
...
<body>
    <div id="information">
        <div class="row">
            ...
            <div class="col col-md-4">
                Email: dotienduongptit@gmail.com
            </div>
            <div class="col col-md-4">
                FB: https://www.facebook.com/profile.php?id=100037991831899
            </div>
        </div>
        <!-- NAVBAR  -->
        <div id="navbar">
